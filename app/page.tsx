  ...
  return (
    <>
      <motion.div 
        ...
        className={`mt-20 w-[95vw] max-w-7xl aspect-video rounded-[2rem] sm:rounded-[3rem] bg-surface/50 border border-border/50 shadow-2xl overflow-hidden relative flex items-center justify-center origin-center ${isHovered ? "cursor-none" : "cursor-default"}`}
      >
        <video 
          ref={videoRef}
        ...
        <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 bg-black/60 backdrop-blur-xl text-white px-5 py-2.5 rounded-full font-sans text-sm font-medium border border-white/10 flex items-center gap-3 pointer-events-none z-10 shadow-xl">
        ...
        <AnimatePresence>
          {isHovered && !showPopup && (
            ...
            >
              <div className="bg-accent text-paper px-5 py-3 rounded-full font-sans font-medium text-sm shadow-xl flex items-center gap-2 whitespace-nowrap">
        ...
        {showPopup && (
          ...
          >
            <motion.div 
              ...
              className="bg-surface border border-border/50 p-8 rounded-3xl max-w-sm w-full shadow-2xl"
            >
              ...
              <div className="flex gap-4 mt-8">
                <button 
                  ...
                  className="flex-1 py-3 rounded-full bg-paper border border-border text-ink hover:bg-border transition-colors font-medium text-sm"
                >
                  No, stay here
                </button>
                <button 
                  onClick={handleConfirm}
                  className="flex-1 py-3 rounded-full bg-accent text-paper hover:bg-accent-hover transition-colors font-medium text-sm shadow-lg shadow-accent/20"
                >
                  Yes, let's go
                </button>
              </div>
              ...
              {["The", "Web3", "developer"].map((word, i) => (
                <span key={`l1-${i}`} className="overflow-hidden inline-block pb-4 -mb-4">
                  <motion.span className={`inline-block ${word === "Web3" ? "text-accent relative" : ""}`} variants={slideUpVariant}>
                    {word}
                    {word === "Web3" && <div className="absolute -bottom-1 left-0 w-full h-1.5 bg-accent rounded-full"></div>}
                  </motion.span>
                </span>
              ))}
        ...
        <div className="py-24 space-y-32">
          ...
          <section className="flex flex-col md:flex-row items-center gap-12 md:gap-20 max-w-7xl mx-auto">
            ...
            >
              <div className="relative mb-8">
                {/* Logo Glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#9945FF] to-[#14F195] blur-[30px] rounded-full opacity-40 animate-pulse"></div>
                
                <div className="w-16 h-16 rounded-2xl bg-surface/80 backdrop-blur-xl border border-border/50 flex items-center justify-center shadow-lg relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://solana.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-paper border border-border text-ink hover:text-white hover:border-[#14F195]/50 transition-colors font-medium text-sm group/link shadow-sm">
                  Official Website
                  <ArrowUpRight className="w-4 h-4 text-ink-dim group-hover/link:text-[#14F195] transition-colors" />
                </a>
                <a href="/projects?ecosystem=solana" className="flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-surface border border-border/50 text-ink hover:bg-border transition-colors font-medium text-sm shadow-sm">
                  View My Projects
                </a>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-[4/3] sm:aspect-square md:aspect-[4/3] rounded-[2rem] border border-border/50 relative flex items-center justify-center overflow-hidden bg-surface/30">
                 {/* Animated Gradient Glows (Solana) */}
                 <motion.div 
                   animate={{ scale: [1, 1.3, 1], opacity: [0.3, 0.6, 0.3], x: [0, 50, 0], y: [0, 50, 0] }}
                   transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
                   className="absolute top-0 left-0 w-3/4 h-3/4 bg-[#9945FF] blur-[100px] rounded-full pointer-events-none"
                 />
                 <motion.div 
                   animate={{ scale: [1, 1.4, 1], opacity: [0.3, 0.6, 0.3], x: [0, -50, 0], y: [0, -50, 0] }}
                   transition={{ duration: 15, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                   className="absolute bottom-0 right-0 w-3/4 h-3/4 bg-[#14F195] blur-[100px] rounded-full pointer-events-none"
                 />

                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 sm:w-3/4 h-3/4 bg-[#111111]/80 backdrop-blur-2xl rounded-xl border border-white/10 shadow-2xl flex flex-col overflow-hidden z-10">
                    {/* Mock Code window */}
          ...
          <section className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-20 max-w-7xl mx-auto">
            ...
            >
              <div className="aspect-[4/3] sm:aspect-square md:aspect-[4/3] rounded-[2rem] border border-border/50 relative flex items-center justify-center overflow-hidden bg-surface/30">
                 ...
                 <motion.div 
                   animate={{ scale: [1, 1.3, 1], opacity: [0.3, 0.6, 0.3], x: [0, 50, 0], y: [0, 50, 0] }}
                   transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
                   className="absolute top-0 left-0 w-3/4 h-3/4 bg-[#4CA2FF] blur-[100px] rounded-full pointer-events-none"
                 />
                 <motion.div 
                   animate={{ scale: [1, 1.4, 1], opacity: [0.3, 0.6, 0.3], x: [0, -50, 0], y: [0, -50, 0] }}
                   transition={{ duration: 15, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                   className="absolute bottom-0 right-0 w-3/4 h-3/4 bg-[#0284AD] blur-[100px] rounded-full pointer-events-none"
                 />
            ...
            >
              <div className="relative mb-8">
                {/* Logo Glow */}
                <div className="absolute inset-0 bg-[#4CA2FF] blur-[30px] rounded-full opacity-40 animate-pulse"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://sui.io" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-paper border border-border text-ink hover:text-white hover:border-[#4CA2FF]/50 transition-colors font-medium text-sm group/link shadow-sm">
                  Official Website
                  <ArrowUpRight className="w-4 h-4 text-ink-dim group-hover/link:text-[#4CA2FF] transition-colors" />
                </a>
                <a href="/projects?ecosystem=sui" className="flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-surface border border-border/50 text-ink hover:bg-border transition-colors font-medium text-sm shadow-sm">
                  View My Projects
                </a>
              </div>
            </motion.div>
        ...
        <section className="py-24 max-w-5xl mx-auto w-full px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[240px]">
            ...
            <motion.a 
              ...
              className="md:col-span-2 rounded-[2rem] bg-surface/30 border border-border/50 hover:bg-surface/60 transition-all p-8 flex flex-col justify-between relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-accent/20 blur-[80px] rounded-full pointer-events-none group-hover:opacity-100 transition-opacity opacity-0"></div>
              <div className="w-12 h-12 rounded-full bg-surface border border-border/50 flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
            ...
            <motion.a 
              ...
              className="md:col-span-1 rounded-[2rem] bg-surface/30 border border-border/50 hover:bg-surface/60 transition-all p-8 flex flex-col justify-between relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 w-48 h-48 bg-red-500/20 blur-[60px] rounded-full pointer-events-none group-hover:opacity-100 transition-opacity opacity-0"></div>
              <div className="w-12 h-12 rounded-full bg-surface border border-border/50 flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
            ...
            <motion.a 
              ...
              className="md:col-span-1 rounded-[2rem] bg-surface/30 border border-border/50 hover:bg-surface/60 transition-all p-8 flex flex-col justify-between relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 w-48 h-48 bg-blue-500/20 blur-[60px] rounded-full pointer-events-none group-hover:opacity-100 transition-opacity opacity-0"></div>
              <div className="w-12 h-12 rounded-full bg-surface border border-border/50 flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
            ...
            <motion.a 
              ...
              className="md:col-span-1 rounded-[2rem] bg-surface/30 border border-border/50 hover:bg-surface/60 transition-all p-8 flex flex-col justify-between relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 w-48 h-48 bg-pink-500/20 blur-[60px] rounded-full pointer-events-none group-hover:opacity-100 transition-opacity opacity-0"></div>
              <div className="w-12 h-12 rounded-full bg-surface border border-border/50 flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
            ...
            <motion.a 
              ...
              className="md:col-span-1 rounded-[2rem] bg-surface/30 border border-border/50 hover:bg-surface/60 transition-all p-8 flex flex-col justify-between relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 w-48 h-48 bg-cyan-400/20 blur-[60px] rounded-full pointer-events-none group-hover:opacity-100 transition-opacity opacity-0"></div>
              <div className="w-12 h-12 rounded-full bg-surface border border-border/50 flex items-center justify-center relative z-10 group-hover:scale-110 transition-transform">
